...
public class V1 extends OpMode {
    ...
    public void loop() {
        ...
        // rgb light control
        if (Subsystems.artifactCount == 1) {
            Light.red();
        } else if (Subsystems.artifactCount == 2) {
            Light.yellow();
        } else if (Subsystems.artifactCount == 3) {
            Light.green();
        } else if (Subsystems.artifactCount == 0) {
            Light.blue();
        }
        ...
        if (gamepad2.rightStickButtonWasPressed()) {
            ...
            SpindexerHelper.SpindexerMotor.setTargetPosition(0);
            SpindexerHelper.SpindexerMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        }

        if (gamepad2.leftStickButtonWasPressed() || gamepad1.leftStickButtonWasPressed()) {
            Subsystems.artifactCount = 0;
        }
